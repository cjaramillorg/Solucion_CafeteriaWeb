		...
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					...
					<h1 class="brand">VICFELCRI</h1>
					<!-- navigation -->
					<nav class="pull-right nav-collapse collapse">
						<ul id="menu-main" class="nav">
							
							<li><a runat="server" title="services" href="#services">Servicios</a></li>
							<li><a runat="server" title="works" href="#works">Carta de menu</a></li>
							<li><a runat="server" href="~/Account/Login">Iniciar sesión</a></li>
							<li><a runat="server" title="contact" href="#contact">Contactenos</a></li>
							...
							<ul class="slides">
								<li>
									<p class="home-slide-content">
										<strong>creatividad</strong> y pasíon
									</p>
								</li>
								<li>
									<p class="home-slide-content">
										comida o un cafe? <strong>a diseñar!</strong>
									</p>
								</li>
								<li>
									<p class="home-slide-content">
										Amamos lo  <strong>simple</strong>
									</p>
								</li>
							</ul>
						</div>
			...
			<div class="row">
				<div class="span6 alignright flyLeft">
					<blockquote class="large">
						En la lucha contra la realidad, el hombre tiene solo un arma: la imaginación. <cite><i>Thepphile gautier</cite></i>
					</blockquote>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="span4 offset1">
					<div>
						<h2>Amo vivir con la  <strong>creatividad</strong></h2>
						<p>
							si me pongo a pensar las veces que he cambiado el mundo en mi cabeza, me hubiera puesto a escribir codigo hace mucho tiempo atrás,
							lo importante es que el tiempo llegó para darle solucion a tu <b><i>necesidad.</i></b>
						</p>
					</div>
				</div>
				<div class="span6">
			...
			<div class="row">
				<div class="span3 animated-fast flyIn">
					<div class="service-box">
						...
						<h2>Diseño Web</h2>
						<p>
							Líderes en marketing y amigable diseño.
						</p>
					</div>
				</div>
				...
				<div class="span3 animated-fast flyIn">
					<div class="service-box">
						...
						<h2>Fotografía</h2>
						<p>
							¡Nos encargamos de seleccionar el mejor material para mostrar lo mejor de ti!
						</p>
					</div>
				</div>
				<div class="span3 animated-slow flyIn">
					<div class="service-box">
						...
						<h2>Comercio Digital</h2>
						<p>
							competimos con grandes proveedores de servicio digital ;)
						</p>
					</div>
				</div>
			</div>
